...
class Audit(Base):
    ...
    commentaires = relationship("Commentaire", back_populates="audit", cascade="all, delete-orphan")
    pieces_jointes = relationship("PieceJointe", back_populates="audit", cascade="all, delete-orphan")
